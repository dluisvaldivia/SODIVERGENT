...
const esp = {
    ...
    accessibility: {
        ...
        commitment_p2: "Gracias por tu comprensión y por ser parte de la comunidad That's Very ADHD."
    },
    others: {
        title: "OTROS",
        p1: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
...
const fra = {
    ...
    about: {
        ...
        believe: {
            ...
            p1: "La neurodivergencia n'est pas une collection de troubles qui se chevauchent par hasard. C'est une architecture. Une façon spécifique d'être câblé qui prend tout son sens quand on voit l'ensemble du tableau, et qui n'a presque aucun sens quand on n'en voit qu'une partie.",
